  ...
  */
  ...
  for(int ii=0; ii<N; ii++){
    ...
    while(getline(ifs,str))
      ...
      //ID[ii][iii]=1000 * fabs(ID[ii][iii]);   //change [A] to [mA]
      //cout << "Vg = " << VG[ii][iii] << " Id = " << ID[ii][iii] << endl; 
      VG[ii][iii]=VG[ii][iii] - 1.8 ; //for Pch
  ...
  std::string TITLE ="PTEG2 "+CHIP+FET+" Vd="+Vd+"V"; //for PTEG2
